...
adminRoute.get("/appointments", verifyToken, adminController.getAppointmentsData)
adminRoute.get("/getBestServiceProviders", verifyToken, adminController.getBestServiceProviders)
